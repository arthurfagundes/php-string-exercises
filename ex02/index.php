        ...
        <div class="container py-4">
            ...
            <div class="p-5 mb-4 bg-light rounded-3">
                <div class="input-group mb-3 text-center">
                    ...
                    <input type="text" class="form-control" placeholder="Insira seu CEP" aria-label="Username" aria-describedby="basic-addon1" name="cep">
                </div>
                ...
                <div class="d-inline-flex">
                    ...
                    if (isset($_POST['result'])) {
                        $cep = $_POST['cep'];
                        $cep = substr($cep, -3);
                        echo "<p  class='text-dark fs-3'>Ultimos três números: $cep </p>";
                    }
                    ?>
                </div>
            </div>
